    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.content1}>
                <Text>Post Data</Text>
                <TextInput placeholder="Masukkan judul berita" style={styles.input} value={title}
                onChangeText={(value)=>setTitle(value)}/>
                <TextInput placeholder="Masukkan isi berita" style={styles.input} value={value}
